...
Lightweight [suspense-enabled][suspense] routing library for [ReactJS][react].

- Wrap your routes in a `Router` component and make sure to include a **fallback page**.
- Assign routes to your pages with the `Route` component. Wrap your pages using [lazy][lazy].
...
```bash
npm install flipeador/react-router
```
